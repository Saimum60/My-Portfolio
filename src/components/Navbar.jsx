...
const Navbar = ({ darkMode, toggleDarkMode }) => {
  ...
  const lightColors = {
    navBg: "bg-gradient-to-br from-orange-500 to-white",
  ...
  return (
    <div className="flex justify-center w-full fixed z-50 mt-4">
      <motion.nav
        ...
        className={`flex items-center justify-center ${color.navBg} backdrop-blur-lg rounded-2xl px-4 lg:px-8 py-2 shadow-lg w-[95%] max-w-6xl`}
      >
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center space-x-3">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className={`hidden lg:block px-6 py-2 font-semibold rounded-full bg-gradient-to-r ${color.button} text-white shadow-md`}
            >
              Hire Me
            </motion.a>
          ...
          >
            <div className="px-4 py-3 space-y-2">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className={`block py-3 px-4 text-center font-semibold rounded-lg  ${color.button} text-white`}
              >
                Hire Me
              </motion.a>
            </div>
